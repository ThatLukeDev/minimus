...
This code is now not included, and a font has been hard-
coded into Minimus, due to the fact that VGA Font return
is no longer supported on numerous devices.
...
This code has since been replaced with the Fast A20 function,
which is not supported on all systems, but is mostly a standard.
